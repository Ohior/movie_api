...
async def getMoviesPage(movie_url: str)->str:
...
async def getRecentMovies(url:str):
...
async def mainExecution():
    movies = await getRecentMovies(NIJA_ROCK_URL)
    print(movies)
    # await getMoviesPage("https://9jarocks.net/videodownload/all-about-my-romance-season-1-korean-drama-id306454.html")
